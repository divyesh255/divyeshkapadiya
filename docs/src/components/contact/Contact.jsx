...
const Contact = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    const mailtoLink = `mailto:divyeshkapadiya25@gmail.com?subject=${emailSubject}&body=${emailBody}`;
    ...
    <div id="contact" className="container m-auto mt-16">
      ...
      <div className="card-wrapper w-[90%] sm:w-[100%] mx-auto mt-5 flex items-center justify-center sm:flex-col">
        <div className="left w-[70%] flex-1 flex items-center justify-center sm:flex-col sm:w-full">
          <div className="flex-3 w-1/2 gap-3 flex items-end justify-end  flex-col sm:w-3/4">
            <div data-aos="zoom-in">
              <h1 className="text-5xl font-bold sm:text-3xl">Drop a Mail</h1>
              <h3 className="text-xl sm:text-lg">
                Give a feedback or Contact with me. Thank you :)
              </h3>
            </div>
          </div>
        ...
        <div className="right flex-1">
          <form onSubmit={handleFormSubmit} className="flex justify-center items-center flex-col gap-5 w-[70%] md:w-[100%] sm:w-[95%] mx-auto">
            <input
