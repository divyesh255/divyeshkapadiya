...
import { FaMicrochip, FaMemory, FaStream } from 'react-icons/fa';
      ...
      <div className=" container m-auto  mt-16">
        ...
        <div className="flex md:flex-col ">
          <div className="left flex-1 w-full">
            <p
              data-aos="fade-up"
              className="text-gray-700 font-medium w- mb-0"
  	      style={{ marginBottom: 0, fontSize: '1.25rem', textAlign: 'justify', lineHeight: '1.75', padding: '10px 0' }}
            >
              In this section, I showcase my proficiency in various programming languages and technologies, highlighting my expertise and experience. Below, you will find a visual representation of my skills, each accompanied by an appropriate icon and a proficiency percentage to give you a clear understanding of my capabilities.
            </p>
            ...
            >
              <div className=" flex flex-col gap-7  w-3/4  my-5 md:w-[90%]">
		<ProgressBar logo={<FaStream />} name={"Gstreamer"} value={85} />
                <ProgressBar logo={<SiC />} name={"C"} value={95} />
                <ProgressBar logo={<SiCplusplus />} name={"C++"} value={90} />
                <ProgressBar
                  logo={<FaMicrochip />}
                  name={"Verilog"}
                  value={60}
                />
                <ProgressBar logo={<FaMemory />} name={"Assembly"} value={80} />
              </div>
            </div>
          </div>
